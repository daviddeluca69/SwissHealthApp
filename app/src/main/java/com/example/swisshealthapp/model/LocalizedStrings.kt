...
object LocalizedStrings {
    ...
    private val frenchStrings = mapOf(
        ...
        "language_info" to "La langue sélectionnée sera appliquée à l'ensemble de l'application.",
        "language_warning" to "Attention : le changement de langue réinitialisera tous les objectifs à leurs valeurs par défaut dans la nouvelle langue.",
    ...
    private val englishStrings = mapOf(
        ...
        "language_info" to "The selected language will be applied to the entire application.",
        "language_warning" to "Warning: changing the language will reset all goals to their default values in the new language.",
